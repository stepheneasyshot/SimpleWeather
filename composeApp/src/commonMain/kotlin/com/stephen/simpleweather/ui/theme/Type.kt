package com.stephen.simpleweather.ui.theme
...
val itemContentText = TextStyle(
    fontSize = 16.sp,
    fontWeight = FontWeight.Normal,
    textAlign = TextAlign.Center,
)

val weatherTempText = TextStyle(
    fontSize = 28.sp,
    fontWeight = FontWeight.Bold,
    textAlign = TextAlign.Center,
)

val weatherInfoText = TextStyle(
    fontSize = 20.sp,
    fontWeight = FontWeight.Normal,
    textAlign = TextAlign.Center,
)

val temText = TextStyle(
    fontSize = 12.sp,
    fontWeight = FontWeight.Normal,
    textAlign = TextAlign.Center,
)
